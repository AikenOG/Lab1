...
<html>
<head>
    <title>Задания по Информатике</title>
    <link rel="stylesheet" type="text/css" href="style.css">
    <meta charset="UTF8">
</head>
<body>
    <h1>Задания по Информатике</h1>

    <?php
    $questions = [
        ["question" => "Какое минимальное количество бит необходимо для кодирования 32 различных символов?", "answer" => "5"],
        ["question" => "Как называется устройство для временного хранения данных?", "answer" => "Оперативная память"],
        ["question" => "Какое поколение компьютеров использовало интегральные схемы?", "answer" => "3"],
        ["question" => "Как называется основная плата компьютера?", "answer" => "Материнская плата"],
        ["question" => "Какой язык программирования был создан Джеймсом Гослингом?", "answer" => "Java"]
    ];
